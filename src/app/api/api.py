...
def delete(merchant_id):
    ...
    return RouteController().delete_mid(merchant_id), 200
...
def get(merchant_id):
    ...
    try:
        ...
        return jsonify(str(e)), 422
    return RouteController().get_mid(merchant_id), 200
...
def add():
    ...
    try:
        ...
        return jsonify(str(e)), 422
    return RouteController().add_mid(data['merchantId']), 200
...
def update(merchant_id):
    ...
    try:
        ...
        return jsonify(str(e)), 422
    return RouteController().update_mid(data['code'], merchant_id), 200
